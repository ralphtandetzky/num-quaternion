# Instructions for AI Agents working on the repository

- Always consider the info from the `README.md` and linked documents.
- Don't be so agreeable. If you think something is not a good practice, say it.
  If you think something is missing, say it. If you think something is not
  clear, say it. Discuss it with me.
- Discuss and provide options before altering architecture or introducing new
  dependencies.
